...
To achieve this, we proposed an intuitive formalism for representing [procedures as programs](https://arxiv.org/pdf/2109.08214.pdf) and subsequently applied this concept to broader tasks with large language models ([PaL](https://arxiv.org/pdf/2211.10435.pdf), [CoCoGen](https://arxiv.org/pdf/2210.07128.pdf)).
To navigate the complexities of tasks and adapt to the constant flux of new knowledge, we built the first-ever [hierarchical procedural knowledge base](https://arxiv.org/pdf/2203.07264.pdf). To learn from the knowledge base and generating new, previously unseen procedures, we designed a retrieval-augmented model ([DocPrompting](https://arxiv.org/pdf/2207.05987.pdf)), 
